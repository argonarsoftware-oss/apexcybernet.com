...
<div class="success-container">
    ...
    <?php elseif ($type === 'solo'): ?>
        <p>You've been registered for <?= htmlspecialchars($game_name) ?> solo matchmaking. Once your ₱110 entry is confirmed, your slot is locked in. See you at Apex Cybernet Cafe on July 11.</p>
    <?php else: ?>
        <p>Your team has been registered for <?= htmlspecialchars($game_name) ?>. Once your ₱550 entry is confirmed, your slot is locked in. See you at Apex Cybernet Cafe on July 11.</p>
    <?php endif; ?>
