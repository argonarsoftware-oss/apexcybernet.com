...
$pageTitle       = 'Terms of Service — Argonar Tournament';
$pageDescription = 'Terms of Service for Argonar Tournament, including H-Coin virtual currency, match prediction features, tournament registration, and platform rules.';
    ...
    <div class="reg-card">
        ...
        $sections = [
            ['title' => '1. Acceptance of Terms', 'body' => '
                By accessing, browsing, or using the Argonar Tournament platform ("Platform"), available at argonar.co and any
                associated subdomains, mobile applications, APIs, or services operated by Argonar Software OPC, you acknowledge
                ...
                <br><br>
                Argonar Software OPC reserves the right, at its sole discretion, to modify, amend, supplement, or replace
            ...
            ['title' => '2. Definitions', 'body' => '
                ...
                <br><br>
                <strong style="color:var(--text-main);">"Platform"</strong> means the Argonar Tournament website at argonar.co,
                including all pages, features, tools, APIs, subdomains, and any mobile or desktop applications provided by
                Argonar Software OPC, whether now existing or developed in the future.
                <br><br>
                <strong style="color:var(--text-main);">"Argonar," "we," "us," "our"</strong> refers to Argonar Software OPC,
                ...
                by Argonar Software OPC for use within the Platform, as further described in Section 7.
                <br><br>
                ...
                by Argonar, enabling point-of-sale (POS) and marketplace functionalities on the Platform.
                <br><br>
                <strong style="color:var(--text-main);">"Force Majeure"</strong> means any event beyond the reasonable control
                of Argonar, including but not limited to natural disasters, pandemics, government actions, civil unrest, war,
            ...
            ['title' => '3. Eligibility and Account Registration', 'body' => '
                ...
                password, and for all activities that occur under your Account. You agree to immediately notify Argonar of
                any unauthorized use of your Account or any other breach of security. Argonar shall not be liable for any
                ...
                of these Terms. Argonar reserves the right to suspend, terminate, or merge duplicate accounts and to forfeit
                ...
                Argonar may suspend, restrict, or permanently terminate your Account at any time, with or without cause,
                with or without notice, including but not limited to situations where Argonar reasonably believes that you
            ...
            ['title' => '4. Tournament Registration and Participation', 'body' => '
                ...
                Registration fees, once paid, are non-refundable except at the sole and absolute discretion of Argonar Software OPC.
                Argonar is under no obligation to issue refunds for registration fees under any circumstances, including but not
                limited to team withdrawal, disqualification, tournament postponement, format changes, or cancellation due to
                Force Majeure events. Where a tournament is cancelled entirely due to reasons within Argonar\'s control,
                Argonar may, but is not obligated to, issue partial or full refunds or alternative compensation such as H-Coins.
                <br><br>
                <strong style="color:var(--text-main);">4.3 Disqualification</strong><br>
                Argonar reserves the right to disqualify any team or individual participant for any of the following reasons,
                ...
                (f) providing false or misleading information during registration; (g) any other conduct that Argonar, in its
                ...
                elimination format, and game selection), and prize structures are subject to change at Argonar\'s sole discretion
                at any time before, during, or after the tournament. Argonar will make reasonable efforts to communicate such
                ...
                Prize amounts, formats, and distribution methods are determined solely by Argonar and are subject to change.
                Prize claims are subject to verification of identity and compliance with these Terms. Any taxes, duties, or
                other charges applicable to prizes are the sole responsibility of the prize recipient. Argonar may withhold
            ...
            ['title' => '5. User Conduct and Prohibited Activities', 'body' => '
                ...
                portion of the Platform without Argonar\'s prior written consent;<br>
                ...
                the same to Argonar;<br>
                (o) Engage in any activity that could create liability for Argonar or cause Argonar to lose (in whole or in part)
                ...
                enforcement authorities, and pursuit of any available legal remedies. Argonar\'s failure to enforce any
            ...
            ['title' => '6. Marketplace and Merchant Services', 'body' => '
                ...
                using H-Coins. All marketplace transactions are between Users; Argonar acts solely as the platform facilitator
                and is not a party to any transaction between Users.
                <br><br>
                <strong style="color:var(--text-main);">6.2 Merchant Accounts</strong><br>
                Merchant status is granted at Argonar\'s sole discretion and may be revoked at any time. Merchants are
                ...
                Argonar makes no representations or warranties regarding the quality, safety, legality, or availability of
                any items or services listed on the marketplace. All marketplace transactions are conducted at the Users\'
                own risk. Argonar shall not be liable for any disputes between buyers and sellers.
                <br><br>
                <strong style="color:var(--text-main);">6.4 Transaction Fees</strong><br>
                Argonar reserves the right to impose transaction fees, listing fees, or other charges on marketplace
            ...
            ['title' => '7. H-Coins — Virtual Currency', 'body' => '
                ...
                H-Coins are a non-monetary, non-transferable virtual reward currency issued exclusively by Argonar Software OPC
                for use within the Argonar Tournament Platform. H-Coins are licensed to you, not sold, and you receive a
                ...
                your license to use a feature of the Platform. You agree that Argonar has the absolute right to manage,
                regulate, control, modify, adjust, and/or eliminate H-Coins as it sees fit in its sole discretion, and
                that Argonar shall have no liability to you or anyone else for the exercise of such rights.
                <br><br>
                ...
                and on-site payment); (b) prizes, rewards, or promotional offers at Argonar\'s discretion; (c) winning match
                predictions; (d) any other method Argonar may introduce. The pricing, availability, and methods of acquiring
                H-Coins are subject to change at Argonar\'s sole discretion.
                <br><br>
                ...
                All purchases of H-Coins are final and non-refundable, except where required by applicable law. Argonar is not
                ...
                exceeding twelve (12) months, at Argonar\'s discretion; (d) detection of fraudulent activity, multi-accounting,
                or exploitation of Platform features.
                <br><br>
                <strong style="color:var(--text-main);">7.7 Balance Adjustments</strong><br>
                Argonar reserves the right to adjust, correct, modify, increase, decrease, or reset H-Coin balances at any
                time if Argonar determines, in its sole discretion, that balances have been affected by a bug, exploit,
                ...
                Argonar Software OPC is not a bank, money service business, electronic money issuer, remittance agent,
            ...
            ['title' => '8. Platform Buyback Program', 'body' => '
                ...
                As a courtesy to Users, Argonar may, at its sole and absolute discretion, offer to purchase H-Coins from Users
                at a rate determined by Argonar (currently ₱0.85 per H-Coin) ("Buyback Program"). This is a voluntary,
                ...
                (a) The Buyback Program is offered at Argonar\'s sole discretion and may be modified, suspended, limited, or
                discontinued at any time with or without notice;<br>
                (b) Argonar reserves the right to change the buyback rate at any time;<br>
                ...
                (d) Argonar may impose daily, weekly, or monthly limits on the total amount of H-Coins that may be bought back;<br>
                (e) Argonar may reject buyback requests at its discretion, including but not limited to cases where fraud,
                ...
                Argonar may suspend, limit, or discontinue the Buyback Program for any User or all Users at any time, and Users
                ...
                received through the Buyback Program. Argonar does not provide tax advice and is not responsible for any tax
            ...
            ['title' => '9. Match Predictions — Skill-Based Entertainment Feature', 'body' => '
                ...
                convenience service that Argonar may offer, modify, or discontinue at any time. There is no guaranteed,
                ...
                Argonar Software OPC is not a licensed gambling operator, gaming operator, or betting operator under any
                Philippine law or regulation. The Platform does not operate or facilitate any form of gambling as defined under
                applicable law. Argonar does not accept, process, or facilitate wagers involving real currency on match outcomes.
                ...
                Argonar reserves the right to cancel, modify, suspend, or discontinue the Predict feature or any individual
                ...
                prediction pool, committed H-Coins will be refunded to Users. Argonar is not liable for any expected or
                ...
                A minimum prediction of 10 H-Coins is required per match. Argonar reserves the right to change the minimum
                ...
                (c) Argonar does not provide advice on predictions and is not responsible for the outcome of any prediction;
            ...
            ['title' => '11. Intellectual Property', 'body' => '
                <strong style="color:var(--text-main);">11.1 Argonar Content</strong><br>
                ...
                feel" of the Platform, is the exclusive property of Argonar Software OPC or its licensors and is protected by
                ...
                Subject to your compliance with these Terms, Argonar grants you a limited, non-exclusive, non-transferable,
                ...
                "Argonar," "Argonar Tournament," "H-Coin," the Argonar logo, and all related names, logos, product and service
                names, designs, and slogans are trademarks or service marks of Argonar Software OPC. You must not use such marks
                without the prior written permission of Argonar. All other names, logos, product and service names, designs,
                ...
                display names, profile information, dispute submissions, and marketplace listings), you grant Argonar a
                ...
                in connection with the Platform and Argonar\'s business. You represent and warrant that you own or have the
            ...
            ['title' => '12. Disclaimers and Limitation of Liability', 'body' => '
                ...
                OR OTHERWISE. TO THE FULLEST EXTENT PERMITTED BY APPLICABLE LAW, ARGONAR DISCLAIMS ALL WARRANTIES, INCLUDING
                ...
                Argonar does not warrant that the Platform will be uninterrupted, timely, secure, error-free, or free of
                viruses or other harmful components. Argonar does not warrant that the results obtained from the use of the
                ...
                TO THE MAXIMUM EXTENT PERMITTED BY THE LAWS OF THE REPUBLIC OF THE PHILIPPINES, ARGONAR SOFTWARE OPC, ITS
                ...
                LIABILITY, OR ANY OTHER LEGAL THEORY, AND REGARDLESS OF WHETHER ARGONAR HAS BEEN ADVISED OF THE POSSIBILITY
                OF SUCH DAMAGES.
                <br><br>
                <strong style="color:var(--text-main);">12.4 Specific Exclusions</strong><br>
                Without limiting the generality of the foregoing, Argonar shall not be liable for: (a) loss of H-Coin balances
                ...
                The limitations of liability in this Section reflect a fair and reasonable allocation of risk between Argonar
                and you, and form an essential basis of the bargain between Argonar and you. Argonar would not be able to
                provide the Platform to you on an economically reasonable basis without these limitations.
            '],
            ['title' => '13. Indemnification', 'body' => '
                You agree to indemnify, defend, and hold harmless Argonar Software OPC, its owner, officers, directors,
            ...
            ['title' => '14. Dispute Resolution', 'body' => '
                ...
                Argonar through the <a href="' . base_url('contact.php') . '" style="color:var(--accent-light);">contact form</a>.
                Argonar will attempt to resolve the dispute informally within thirty (30) days. If the dispute is not resolved
                ...
                any right to participate in a class action lawsuit or class-wide arbitration against Argonar.
                <br><br>
            ...
            ['title' => '16. Third-Party Services and Links', 'body' => '
                ...
                for Dota 2; Riot Games for Valorant; Smilegate for CrossFire). Argonar is not responsible for the availability,
                ...
                solely for identification and descriptive purposes. Argonar is not affiliated with, sponsored by, or endorsed
                ...
                The Platform may contain links to third-party websites or services that are not owned or controlled by Argonar.
                Argonar has no control over, and assumes no responsibility for, the content, privacy policies, or practices
                of any third-party websites or services. You acknowledge and agree that Argonar shall not be responsible or
            ...
            ['title' => '17. Force Majeure', 'body' => '
                Argonar shall not be liable for any failure or delay in performing its obligations under these Terms where
                ...
                data breaches), labor disputes, supply chain disruptions, or any other event beyond Argonar\'s reasonable
                control. In the event of a Force Majeure event, Argonar\'s obligations will be suspended for the duration
                of the event, and Argonar will use commercially reasonable efforts to resume performance as soon as
                practicable.
            '],
            ...
            ['title' => '19. Entire Agreement', 'body' => '
                ...
                constitute the entire agreement between you and Argonar regarding the use of the Platform and supersede all
                ...
                unless in writing and signed by Argonar or posted on the Platform.
            '],
            ['title' => '20. Waiver', 'body' => '
                The failure of Argonar to exercise or enforce any right or provision of these Terms shall not constitute a
                waiver of such right or provision. No waiver of any provision shall be deemed a further or continuing waiver
                of such provision or any other provision, and Argonar\'s failure to assert any right or provision under these
            ...
            ['title' => '21. Assignment', 'body' => '
                ...
                otherwise, without Argonar\'s prior written consent. Argonar may freely assign or transfer these Terms without
            ...
            ['title' => '22. Electronic Communications', 'body' => '
                ...
                Argonar, including but not limited to on-Platform notifications, emails regarding your Account, and
                ...
                writing. You acknowledge that Argonar may communicate with you via on-Platform notification systems, and
            ...
            ['title' => '24. User Representations and Warranties', 'body' => '
                ...
                <br><br>
                (a) All information you provide to Argonar is truthful, accurate, current, and complete;<br>
                ...
                and forfeiture of H-Coin balances, in addition to any other remedies available to Argonar under these Terms
                or applicable law.
            '],
            ['title' => '25. Platform Availability and Maintenance', 'body' => '
                <strong style="color:var(--text-main);">25.1 No Uptime Guarantee</strong><br>
                Argonar does not guarantee that the Platform will be available at all times or at any particular time. The
                ...
                Argonar may perform scheduled maintenance on the Platform from time to time. While we will make reasonable
                ...
                Argonar may perform emergency maintenance at any time without prior notice in response to security threats,
                ...
                Argonar reserves the right to modify, update, add, remove, or discontinue any feature, functionality, or
                ...
                system, and any other Platform feature. Argonar is not liable for any loss, inconvenience, or damage resulting
                from such changes.
                <br><br>
                <strong style="color:var(--text-main);">25.5 Data Loss</strong><br>
                While Argonar takes reasonable measures to protect data, we do not guarantee against data loss. Argonar is
            ...
            ['title' => '26. Beta Features and Experimental Services', 'body' => '
                ...
                Argonar may, from time to time, offer new features, tools, or services on the Platform on a beta, preview,
                ...
                Argonar is under no obligation to: (a) continue offering any Beta Feature; (b) make any Beta Feature generally
                ...
                If you provide feedback, suggestions, ideas, or recommendations to Argonar regarding the Platform or any of its
                features ("Feedback"), you hereby grant Argonar a perpetual, irrevocable, worldwide, royalty-free, fully
                ...
                compensation, attribution, or obligation to you. You acknowledge that Argonar is not obligated to use any
                Feedback and that Argonar may already be independently developing or may in the future independently develop
            ...
            ['title' => '27. Notifications and Communications', 'body' => '
                ...
                Argonar may send you notifications through the Platform\'s built-in notification system regarding your Account,
                ...
                Argonar may communicate with you through: (a) on-Platform notification banners; (b) the notification bell
                system; (c) email to the address associated with your Account; (d) public announcements on the Platform;
                (e) any other method Argonar deems appropriate. It is your responsibility to ensure that your contact
                ...
                Any notice sent by Argonar through the Platform notification system or to your registered email address shall
                ...
                <br><br>
                <strong style="color:var(--text-main);">27.4 Notices to Argonar</strong><br>
                Any legal notices to Argonar must be submitted in writing through official channels. Notices sent through
            ...
            ['title' => '28. Relationship of the Parties', 'body' => '
                ...
                franchise relationship between you and Argonar. You have no authority to bind Argonar in any way, including
                but not limited to making representations, warranties, or commitments on behalf of Argonar. You and Argonar
                are independent parties, and neither party has the power to bind the other or to incur obligations on behalf
                of the other. No User shall be considered an employee, agent, partner, or representative of Argonar by
            ...
            ['title' => '29. Anti-Money Laundering and Financial Crime', 'body' => '
                ...
                Argonar reserves the right to monitor transactions and activities on the Platform for suspicious patterns,
                unusual behavior, or potential financial crime. Argonar may, at its sole discretion, freeze, suspend, or
                ...
                You agree to cooperate with Argonar and any government authority in connection with any investigation
            ...
            ['title' => '30. Confidentiality', 'body' => '
                ...
                Any non-public information disclosed by Argonar to you in connection with the Platform, including but not
                ...
                disseminate such information to any third party without Argonar\'s prior written consent.
                <br><br>
                ...
                internal dashboards, or non-public Platform features without Argonar\'s prior written consent.
                <br><br>
            ...
            ['title' => '31. Compliance with Local Laws', 'body' => '
                ...
                your jurisdiction, to the extent applicable. Argonar makes no representation that the Platform or its features
            ...
            ['title' => '32. Interpretation', 'body' => '
                ...
                These Terms are intended solely for the benefit of you and Argonar and do not create any third-party
            ...
            ['title' => '33. Changes to Terms', 'body' => '
                Argonar Software OPC reserves the right to update, modify, supplement, or replace these Terms at any time
